          ...
          >
            {codingImages.map((image, index) => (
              ...
              >
                ...
                {/* Image Icon */}
                <div className="absolute top-4 left-4 w-10 h-10 bg-gradient-to-br from-blue-500 to-cyan-600 rounded-lg flex items-center justify-center text-white shadow-lg">
