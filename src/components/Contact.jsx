                ...
                <motion.div key={field} variants={itemVariants}>
                  ...
                  {field === "message" ? (
                    <motion.textarea
                      ...
                      required
                      rows="4"
                      className="w-full px-3 md:px-4 py-3 md:py-4 border border-blue-200 rounded-lg md:rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 bg-white/70 backdrop-blur-sm resize-none pl-10 md:pl-12"
                      placeholder={`Tell us about your ${
                        field === "message" ? "requirements" : field
                      }...`}
                      whileFocus={{ scale: 1.02 }}
                    ...
                    <div className="relative">
                      <motion.input
                        ...
                        onChange={handleChange}
                        required={field !== "phone"}
                        className="w-full px-3 md:px-4 py-3 md:py-4 border border-blue-200 rounded-lg md:rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 bg-white/70 backdrop-blur-sm pl-10 md:pl-12"
                        placeholder={`Enter your ${field}`}
                        whileFocus={{ scale: 1.02 }}
                      />
                    </div>
